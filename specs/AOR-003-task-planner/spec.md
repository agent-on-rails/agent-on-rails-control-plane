...
4. Persist graph for scheduling and GitHub Issue representation.
5. Re-planning is versioned; do not silently rewrite in-flight task identities without audit.
